...
namespace UncballArena.Core.Auth
{
    public interface IAuthService
    {
        ...
        Task UnlinkGoogleAsync(CancellationToken cancellationToken);
        Task UnlinkAppleAsync(CancellationToken cancellationToken);
        Task UnlinkProviderAsync(AuthProviderType providerType, CancellationToken cancellationToken);
